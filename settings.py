class Settings:
    """
     Cодержит параметры конфигурации игры, такие как размеры экрана, стоимость и параметры башен, пути к ресурсам и т.д.
    """
    def __init__(self):
        ...
        self.enemy_path2 = [
            (50, 500), (350, 500), (350, 300), (550, 300),
            (550, 700), (950, 700), (950, 400), (1150, 400)
        ]

        self.tower_sprites = {
            'basic': 'assets/towers/basic_tower.png',
            'sniper': 'assets/towers/sniper_tower.png',
            'money': 'assets/towers/money_factory.png'
        }
